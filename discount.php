            	...
            	<div class="chkmid-lft">
                    ...
                    <div class="hero_checkout" id="togglebox">
                        ...
                        <div class="hero_right">
                            ...
                            <p><strong style="color: #32b567;">VIRGINIA FARMS CBD OIL</strong></p>
                ...
                <div class="chkmid-rgt">
                    ...
                    <div class="chkfrm-mid">
                        ...
                        <div class="frmElemts">
                            ...
                            <input type="text" name="billingAddress1" placeholder="Apt#" data-error-message="Please enter your billing address!" />
                        </div>
                        <div class="frmElemts">
                            <label for="">Zip:</label>

                            <input type="text" name="billingZip" maxlength="5" placeholder="Billing Zip Code" data-error-message="Please enter a valid billing zip code!" onkeyup="javascript: this.value = this.value.replace(/[^0-9]/g, '');" />
                        </div>
                        ...
                        <div class="frmElemts">
                                ...
                                <a style="font-size: 12px; text-decoration: none; position: relative; top: 5px; margin-left: 10px;" href="javascript:void(0);" class="cvvTip" onClick="javascript:openNewWindow('cvv.html','modal');"> Whats This?</a>
                           </div>
                            <div class="frmElemts expedited_process_chkbox">
							<img src="app/desktop/images/expedited-process.png" style="height: 45px;margin-left: 0;float: left;margin-top: -13px;" />
...
<input type="checkbox" name="expedited_process_chkbox" value="1" checked="checked">
                           <p>Expedited Processing Fee $3.99</p>
                            ...
                            <div class="clearall"></div>
                            <input type="submit" class="discount_form chkbtn pulse" value="" style="margin-top:5px;"/>
                         </div>
                      </div>
...
<script type="text/javascript">
     $('.discount_form').click(function(e){
        var billingSameAsShipping1 = '',
            ...
            billingState1           = $('#billingState option:selected').val();
        ...
        if($('input[name="billingSameAsShipping"]:checked').val() == 'no'){
            ...
            if(billingZip1 == '') {
                $("#custom_error_div").append('<li>Enter a valid Billing Zip</li>');
                check_status = 1;
            }
        }
