...
include_once('includes/upsell1_header.php'); ?>
<body>
     <div class="up-bg">
	<div class="container">
		<div class="up-mid-bg">
            ...
            <div class="strip">
                ...
                <p class="strip-txt2">93% of customers that purchases <span>Virginia Farms Oil</span> also purchased <span>Virginia Farms Single Full-Flower Hand Roll</span> </p>
            </div>
         	<div class="up-bg2">
                <div class="up-bg1-left">
                	<img src="app/desktop/images/upsell1-img.jpg" width="400" height="500" alt="" />
                </div>
            	<div class="up-bg1-right">
                	<p class="up-bg1-right-txt1"><b>Amplify YOUR RESULTS</b><br><span>with</span>
					<br><b class="cog" style="text-transform:none;">Virginia Farms Single Full-Flower Hand Roll</b><br>
                    </p>
                    <div class="upsell1-green-bg">
                        <p class="up-bg1-right-txt2">Get Your Exclusive Discounted Bottle<br />
    Just Pay a <span>Price of</span><br /><span class="price">$8.95</span></p>
            ...
            <div class="strip" style="height:auto;">
            	<p class="strip2-txt1">HOW <span>Virginia Farms Single Full-Flower Hand Roll </span> WORK<br />
TO <span>SUPPORT HEALTH & WELLNESS</span> </p>
            </div>
         	<p class="clearall"></p>
            <div class="three-box">
                <div class="box1">
                	<img src="app/desktop/images/box1-img2.jpg" />
                    <p class="box-txt1">Supports Cognitive Health</p>
                    <p class="box-txt2">Medliver Virginia Farms Single Full-Flower Hand Roll helps boost cognitive health and performance including focus, clarity, and memory. </p>
                </div>
                <div class="box2">
                	<img src="app/desktop/images/box2-img2.jpg" />
                    <p class="box-txt1">Supports Healthy Sleep</p>
                    <p class="box-txt2">Virginia Farms Single Full-Flower Hand Roll help improve sleep patterns, so you have a great nights sleep and wake up refreshed. </p>
                </div>
                <div class="box3">
                	<img src="app/desktop/images/box3-img2.jpg" />
                    <p class="box-txt1">Offers Antioxidant Support </p>
                    <p class="box-txt2">Virginia Farms Single Full-Flower Hand Roll work at a cellular level to combat free radical damage and boost overall immunity.</p>
                </div>
                <p class=" clearall"></p>
		...
		<a href="upsell2.php?<?php echo (isset($_SERVER["QUERY_STRING"]) ?  $_SERVER["QUERY_STRING"]:'');?>" class="cut-txt"><img src="app/desktop/images/cut.png" width="18" height="15" alt="" class="cut-txt">
      ...
      <form name="is-upsell" class="is-upsell" id="is-upsell" accept-charset="utf-8" enctype="application/x-www-form-urlencoded;charset=utf-8">
          <input type="hidden" name="f_val" value="import_upsell1"/>
            ...
            $.ajax({
                ...
                success:function(msg){
                    ...
                    if(msg=="success"){
                        ...
                        window.location.href = "upsell2.php"+url_prm;
                    }
                    else{
                        $("#loading-indicator").hide();
                        alert(msg);
