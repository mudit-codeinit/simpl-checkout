...
<div id="container">
  	<div class="getheight">
        ...
        <div class="sec1-bg">
          <p class="s1-txt1">93% of customers that purchases<br /> <span>Virginia Farms Oil</span> also purchased<br /><span>Virginia Farms Single Full-Flower<br /> Hand Roll</span></p>
       	  <p class="s1-txt2"></p>

          <img src="assets/images/upsell1-img.jpg" alt=""  class="product" style="max-width:80%;"/>
          <p class="result-txt">AMPLIFY YOUR RESULTS<br><span>with</span><br>Virginia Farms Single Full-Flower<br /> Hand Roll</p>

          <div class="price-bx">
          	  <p class="price-bx-hding">Get Your Exclusive Discounted Bottle<br /> Just Pay a <span>Price</span> of</p>
              <p class="prc-txt">$8.95</p>
     ...
     <div id="section2">
       <a onclick="submit_form()"   href="javascript:;"><img src="assets/images/up-btn.png" alt=""  class="up-btn pulse"/></a>
        ...
        <div class="blu-strip2">
        	<p class="blu-strip2-txt1">HOW <span>Virginia Farms Single Full-Flower Hand Roll </span> WORK TO <span>SUPPORT HEALTH & WELLNESS</span></p>
        </div>
    </div>
    <div id="section3">
    	<div class="s3-box1">
   	    	<img src="assets/images/up2-box1.png" alt=""  class="box-img"/>
            <p class="box-p1">Supports Cognitive Health</p>
            <p class="box-p2">Medliver Virginia Farms Single Full-Flower Hand Roll helps boost cognitive health and performance including focus, clarity, and memory. </p>
        </div>
        <div class="s3-box2">
        	<img src="assets/images/up2-box2.png" alt=""  class="box-img"/>
            <p class="box-p1">Supports Healthy Sleep</p>
            <p class="box-p2">Virginia Farms Single Full-Flower Hand Roll help improve sleep patterns, so you have a great nights sleep and wake up refreshed. </p>
        </div>
        <div class="s3-box3">
        	<img src="assets/images/up2-box3.png" alt=""  class="box-img"/>
            <p class="box-p1">Offers Antioxidant Support </p>
            <p class="box-p2">Virginia Farms Single Full-Flower Hand Roll work at a cellular level to combat free radical damage and boost overall immunity.</p>
        </div>
    </div>
    <div id="section2"  style="padding-bottom:40px;">
        <a onclick="submit_form()"   href="javascript:;"><img src="assets/images/up-btn.png" alt=""  class="up-btn pulse"/></a>
        <div class="clearall"></div>
        <a href="upsell-2.php?<?php echo (isset($_SERVER["QUERY_STRING"]) ?  $_SERVER["QUERY_STRING"]:'');?>" class="no-thank"><img src="assets/images/cross.png" alt="">
  ...
  $.ajax({
      ...
      success:function(msg){
          ...
          if(msg=="success"){
              ...
              window.location.href = "upsell-2.php"+url_prm;
          }
          else{
              $("#loading-indicator").hide();
              alert(msg);
